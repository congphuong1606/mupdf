...
public class BlankFragment extends Fragment {
    ...
    private BlankFragment.TopBarMode mTopBarMode = BlankFragment.TopBarMode.Main;
    ...
    public void createUI(Bundle savedInstanceState) {
        ...
        mDocView = new ReaderView(getActivity().getApplicationContext()) {
            ...
            protected void onTapMainDocArea() {
                if (!mButtonsVisible) {
                    ...
                    if (mTopBarMode == BlankFragment.TopBarMode.Main)
                        hideButtons();
                }
            }
        ...
        RelativeLayout layout = (RelativeLayout)v.findViewById(R.id.rllayout);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (mTopBarMode == BlankFragment.TopBarMode.Search)
    ...
    private void searchModeOn() {
        if (mTopBarMode != BlankFragment.TopBarMode.Search) {
            mTopBarMode = BlankFragment.TopBarMode.Search;
    ...
    private void searchModeOff() {
        if (mTopBarMode == BlankFragment.TopBarMode.Search) {
            mTopBarMode = BlankFragment.TopBarMode.Main;
            hideKeyboard();
            mTopBarSwitcher.setDisplayedChild(mTopBarMode.ordinal());
            SearchTaskResult.set(null);
...
//        if (mButtonsVisible && mTopBarMode == BlankFragment.TopBarMode.Search) {
//            hideButtons();
//        } else {
//            showButtons();
//            searchModeOn();
